        ...
        <div class="col 12">
            <div class="card mt-5">
                ...
                <div class="card-content">
                    <span class="card-title align center"><h5 class="mb-1 mt-0">Select a seat to continue</h5></span><p></p>
                            ...
                            @foreach ($departure_flights as $flight)
                                <div class="card sticky-action">
                                    ...
                                    <div class="card-action">
                                        <div class="row mb-0">
                                            {!!Form::open(['method' => 'GET', 'route' => ['packagesCar.cars']])!!}
                                            {!!Form::hidden('city', $arrival_city)!!}
                                            {!! Form::hidden('seat_id', 1) !!}
